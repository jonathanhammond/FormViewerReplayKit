...
- (void)setupUI
{
  ...
  //  _documentManager = [[PMDocumentCacheManager alloc] init];
    ...
    CGRect imageFrame = form.frame;
    form.frame = imageFrame;
    form.frame = CGRectMake(0, 0, 1, 1);
 ...
 //   UIButton *start = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    ...
    start.frame = CGRectMake(viewSize.width/4.5, 0, 100, 100);
    ...
    stop.frame = CGRectMake(viewSize.width/2.0, 0, 100, 100);
